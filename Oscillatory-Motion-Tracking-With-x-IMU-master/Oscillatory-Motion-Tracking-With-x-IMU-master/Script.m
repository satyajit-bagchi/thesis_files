...
%samplePeriod = 1/256;
samplePeriod = 1/mpu_sampling_frequency;
...
%Handling the nan because of the label
pgx(1) = mean(pgx)
pgy(1) = mean(pgy)
pgz(1) = mean(pgz)
...
gyr = [pgx pgy pgz]
acc = [pax pay paz]
acc = acc * mpu_ax_sensitivity;
gyr = gyr * mpu_gyro_sensitivity;
% Plot
figure
hold on;
plot(gyr(:,1), 'r');
...
SixDOFanimation(linPosHP, R, ...
                ...
                'CreateAVI', true, 'videowriterNameEnum', false, 'AVIfps', ((1/samplePeriod) / SamplePlotFreq));            
